...
"[project]/StudioProjects/Unichat/apps/web-admin/src/app/api/institution/users/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const upstream = await fetch(`${AUTH}/api/v1/institution/users${qs ? `?${qs}` : ""}`, {
        headers: {
...
async function POST(request) {
    ...
    const upstream = await fetch(`${AUTH}/api/v1/institution/users`, {
        method: "POST",
        headers: {
            Authorization: `Bearer ${token}`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0j3y3e2._.js.map