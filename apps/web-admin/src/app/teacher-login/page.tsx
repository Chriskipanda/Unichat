...
export default function TeacherLoginPage() {
  ...
  return (
    <AuthShell
      ...
      tagline="Register the course and NTA level you teach, and assign a Class Representative."
      features={["Secure OTP login", "Tenant-scoped access"]}
      footer={
        <p className="text-muted-foreground text-xs">
          Institution Admin?{" "}
          <a href="/admin-login" className="font-medium hover:underline" style={{ color: ACCENT }}>
            Sign in here
          </a>
        </p>
      }
      ...
      {step === 1 ? (
        ...
        <div key="step-2" className="animate-fade-up">
          ...
          <p className="text-subtitle mt-1 mb-6">
            Check the code sent to <span className="font-medium text-foreground">{identifier}</span>.
          </p>
